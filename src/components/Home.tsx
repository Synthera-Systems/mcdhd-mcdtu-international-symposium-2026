        ...
        >
          ...
          <motion.div variants={fadeUp}>
            ...
            {[
                // { name: "Prof. Raymond B. Birge", img: "/convenors/raymond-birge.png" , org: "Rutgers School of Biomedical and Health Sciences", loc: "Newark, USA" },
                // { name: "Prof. Dhyan Chandra", img: "/convenors/dhyan-chandra.png" , org: "Roswell Park Comprehensive Cancer Center", loc: "New York, USA" },
                // { name: "Prof. Jerry Chipuk", img: "/speakers/jerry-chipuk.png",org: "Florida International University, USA" },
                // { name: "Prof. Ajay Singh", img: "/speakers/ajay.png", org: "University of Mississipi medical center", loc: "USA"},
        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-6 sm:gap-8 w-full max-w-7xl">
            {[
              ...
              { name: "Department of Health Research (DHR)", src: "/logos/dhr.png" },
